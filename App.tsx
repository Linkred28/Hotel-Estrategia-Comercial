    ...
    return (
        <div className="presentation-container">
            ...
            <section id="slide1" className="slide bg-primary-blue text-white">
                <div className="slide-content text-center">
                    <h1 className="text-5xl md:text-8xl font-black leading-tight mb-6">
                        Estrategia Comercial y Reservas Directas
                    </h1>
                    <p className="text-2xl md:text-4xl text-gray-300">Sección: Ventas + Administración</p>
                </div>
            </section>
            ...
            <section id="slide3" className="slide bg-primary-dark">
                 <div className="slide-content">
                    <h2 className="text-4xl md:text-6xl font-bold text-white mb-12 text-center">La estrategia consiste en:</h2>
